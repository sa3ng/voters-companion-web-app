  ...
  <body>
    ...
    <div class="column is-10 is-offset-1">
      <div class="box content">
        <article class="post">
          <h4>Why vote the pink lugaw fanatic?!?!?</h4>
          <div class="media">
        ...
        <article class="post">
          <h4>BBM: The Best president you will have</h4>
          <div class="media">
            <div class="media-left">
              <p class="image is-32x32">
                <img src="http://bulma.io/images/placeholders/128x128.png">
            ...
            <div class="media-content">
              <div class="content">
                <p>
                  <a href="#">@red</a> posted 40 minutes ago 
                  <span class="tag">Question</span>
                </p>
              </div>
            </div>
        ...
        <article class="post">
          <h4>Kakampinks Unite! NGO Volunteers neeeded!!!!</h4>
          <div class="media">
            <div class="media-left">
              <p class="image is-32x32">
                <img src="http://bulma.io/images/placeholders/128x128.png">
            ...
            <div class="media-content">
              <div class="content">
                <p>
                  <a href="#">@jsmith</a> posted 53 minutes ago 
                  <span class="tag">Question</span>
                </p>
              </div>
            </div>
